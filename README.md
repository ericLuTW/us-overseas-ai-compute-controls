...
- **BL 呈現規則**（2026-09-24）：canonical 中 node_id=0 的 BL 框架性工具，產生器展開至全 15 節點呈現（全鏈適用）；有明確節點映射的 BL 工具（3B001→N2、4A003/3A001→N7、軍事終端用途→N15）只落自己的節點。非 BL 的 node_id=0 工具維持不入圖。
